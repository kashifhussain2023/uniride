        ...
        <DriverInfo>
          <DriverLeft>
            <Typography variant="subtitle2">
              {acceptDriverDetail?.data?.driver_info?.driver_name}
            </Typography>
            <Typography variant="h2" component="h2">
              {acceptDriverDetail?.data?.driver_info?.vehicle_no}
            </Typography>
            <Typography
              variant="subtitle2"
              sx={{
            ...
            >
              {acceptDriverDetail?.data?.driver?.vehicle_color}{' '}
              {acceptDriverDetail?.data?.driver?.vehicle_make}{' '}
              {acceptDriverDetail?.data?.driver?.vehicle_model}{' '}
              {acceptDriverDetail?.data?.driver_info?.vehicle_type}
            </Typography>

            <RatingStar>
              <StarIcon /> {acceptDriverDetail?.data?.driver_info?.driver_rating}
            </RatingStar>
          </DriverLeft>
          {
            <DriverRight>
              <img src={`${acceptDriverDetail?.data?.driver_info?.vehicle_image}`} />
              <div>
                <img src={`${acceptDriverDetail?.data?.driver_info?.driver_image}`} />
              </div>
            </DriverRight>
          }
        </DriverInfo>
