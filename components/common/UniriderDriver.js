...
export default function UniriderDriver() {
  return (
    <>
      ...
      <RouteDriver>
       <MessageBox>Sorry  the customer has cancelled the ride due to Lorem ipsum dolor sit amet, consectetur.</MessageBox>
       <BookingDtl>
       <List>
            <ListItem>
                <BookingLabel>
      ...
      Rate your trip experience
            ...
            <Stack spacing={1}> 
      <RateList ><Rating name="size-medium" defaultValue={2} size="small" /> Behavior</RateList>
      <RateList ><Rating name="size-medium" defaultValue={2} size="small" /> Courtesy</RateList>
      <RateList ><Rating name="size-medium" defaultValue={2} size="small" /> Friendly</RateList>
...
const BookingIcon = styled.div`
  ${({ theme }) => `
    width:40px; flex: 0 0 40px; margin-left:10px;
  `}
`;
