...
export default function CorporateProfile({ userAuth }) {
  ...
  const selectedCorporate =
    corporateList && inputs && inputs.corporate_id
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        await Promise.all([getCorporateProfile(), getCorporateList()]);
      } catch (error) {
              ...
              <ProfileBox>
                ...
                >
                  <Grid lg={12} md={12} sm={12} xs={12}>
                    ...
                    <span className="text-danger">{errors && errors.corporate_email}</span>
                  </Grid>
                  <Grid lg={12} md={12} sm={12} xs={12}>
                    <FormControl>
                      ...
                      <CustomFormControl
                        ...
                        onChange={handleInputChange}
                      />
                      <span className="text-danger">{errors && errors.corporate_emp_id}</span>
                    </FormControl>
                  </Grid>
                  <Grid lg={12} md={12} sm={12} xs={12}>
                    <FormControl>
                      ...
                      <span className="text-danger">{errors && errors.corporate_id}</span>
                    </FormControl>
                  </Grid>
                </Grid>
              </ProfileBox>
